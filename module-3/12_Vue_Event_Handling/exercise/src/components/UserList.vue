  ...
  <div class="container">
    <table id="tblUsers">
      ...
      <tbody>
        <tr>
          <td>
            <input type="checkbox" id="selectAll" v-on:click="toggleAll" />
          </td>
          <td>
            <input
              type="text"
    ...
    <form id="frmAddNewUser" v-on:submit.prevent="showForm" v-show="showForm">
      <div class="field">
      ...
      <button type="submit" class="btn save" v-on:click="saveUser">
        Save User
      </button>
    </form>
  </div>
