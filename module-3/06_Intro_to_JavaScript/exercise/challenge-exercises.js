...
*/
function titleCase(titleString, minorWords) {
    const myArray = titleString.split(" ");
    const minorArray = minorWords.split(" ");

    // set to lowercase
    // set first letter of each word uppercase, except if that word is in minorArray
    // return myArray as a String
