...
public class Exercises {
	...
	public static void main(String[] args) {
        ...
        */
		...
		int raccoonsStillInWoods = playfulRaccoons - hungryRaccoons;
        ...
        */
		...
		int	anotherHungryPigeon = 1;
		int pigeonsEatingTotal = lonelyPigeonEating + anotherHungryPigeon;
        ...
        */
		int owlsOnFence = 3;
		int owlsLateToFence = 2;
		int conspiracyOfOwls = owlsOnFence + owlsLateToFence;

        /* Exercise 7
        7. 2 beavers were working on their home. 1 went for a swim. How many
        beavers are still working on their home?
        */
		int homeRenoBeavers = 2;
		int beaversOutForSwim = 1;
		int beaversStillWorking = homeRenoBeavers - beaversOutForSwim;
        ...
        */
		int toucansOnLimb = 2;
		int intrusiveToucans = 1;
		int ackwardToucans = toucansOnLimb + intrusiveToucans;
        ...
        */
		...
		double dime = .1;
		double nickel = .05;
		double foundMoney = quarter + dime + (nickel * 2);
        ...
        */
		int hiltSnowfall = 29;
		int brecknockSnowfall = 17;
		int hiltMinusSchoolSnow = hiltSnowfall - brecknockSnowfall;
        ...
        */
		...
		double costOfTruck = 3;
		double costOfPencilCase = 2;
		double moneyLeft = hiltDollars - (costOfTruck + costOfPencilCase);
        ...
        */
		...
		int seashellsToGoal = seashellsGoal - collectedSeashells;
        ...
        */
		int oldBooksOnShelf = 38;
		int newBooksOnShelf = 10;
		int totalBooksOnShelf = oldBooksOnShelf + newBooksOnShelf;
        ...
        */
		int legsPerBee = 6;
		int totalBees = 8;
		int totalBeesKnees = legsPerBee * totalBees;
        ...
        */
		double coneCost = .99;
		double coneTwoCones = coneCost*2;
        ...
        */
		...
		int rocksOnHand = 64;
		int moreRocksToGet = totalNeededRocks - rocksOnHand;
        ...
        */
		...
		int milesFromGasToConcert = milesToConcert - milesToGasStation;
        ...
        */
		int hour = 60;
		int morningShoveling = hour + 30;
		int afternoonShoveling = 45;
		int minutesShoveling = morningShoveling + afternoonShoveling;
        ...
        */
		...
		double costForAllHotDogs = hotDogs * costPerHotDog;
        ...
        */
		int cents = 50;
		int pencilCost = 7;
		int pencilsCanBeBought = cents / pencilCost;
        ...
        */
		...
		double change = payment - candyPrice;
        ...
        */
		int hoursPerDay = 24;
		int daysTilGram = 2;
		int hoursTilGram = hoursPerDay * daysTilGram;
        ...
        */
		int cousinsOfKim = 4;
		int gumPerCousin = 5;
		int totalGum = cousinsOfKim * gumPerCousin;
        ...
        */
		...
		double leftoverDollars = danDollars - candyBarCost;
        ...
        */
		int boatsOnALake = 5;
		int peopleOnABoat = 3;
		int peopleOnALake = boatsOnALake * peopleOnABoat;
        ...
        */
		int legosHad = 380;
		int legosLost = 57;
		int legosHasNow = legosHad - legosLost;

        /* Exercise 36
        36. Arthur baked 35 muffins. How many more muffins does Arthur have to
        bake to have 83 muffins?
        */
		int muffinsToBakeInAll = 83;
		int muffinsBakedSoFar = 35;
		int muffinsYetToBake = muffinsToBakeInAll - muffinsBakedSoFar;
        ...
        */
		...
		int compareCrayons = willysCrayons - lucysCrayons;
	    ...
	    */
		double tripTotal = 800.00;
		double distTraveled = 537.00;
		int percTraveled = (int)(distTraveled / tripTotal * 100);
