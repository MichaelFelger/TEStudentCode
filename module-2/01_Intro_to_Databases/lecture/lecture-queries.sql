...
SELECT city_name, state_abbreviation FROM city WHERE state_abbreviation <> 'CA'; -- or use != for not equals
...
-- The names and census regions of all states (and territories and districts) not in the Midwest region (including those that don't have any census region)SELECT
...
SELECT city_name, state_abbreviation, area, population FROM city WHERE state_abbreviation IN ('CT', 'ME', 'MA', 'NH', 'RI', 'RI', 'VT');
