...
INSERT INTO park_state (park_id, state_abbreviations)
VALUES ((SELECT park_id FROM park WHERE park_name = 'Disneyland'), 'CA'); -- this works on dev tier, test tier, production tier
...
UPDATE state SET capital = (SELECT city_id FROM city WHERE city_name = 'Anaheim' AND state_abbreviation = 'CA') WHERE state_abbreviation = 'CA';
...
FROM 
	city
WHERE
	city_name = 'Hawkins' AND state_abbreviation = 'IN';
...
INSERT INTO city(city_name, state_abbreviation, area) VALUES ('Smallville', 'KS', .1);
